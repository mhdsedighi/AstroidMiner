...
LB=[zeros(1,N_sat) -90*ones(1,N_sat) -30*ones(1,N_sat) -30*ones(1,N_sat) 1*ones(1,5)];
UB=[360*ones(1,N_sat) 90*ones(1,N_sat) 30*ones(1,N_sat) 30*ones(1,N_sat) 1*ones(1,5)];
...
% cost_handle=@(inputArg)multi_sim2(inputArg,sim_data);
