% Copyright 2019 Jonas Koenemann, Moritz Diehl, University of Fxeiburg
...
%   sh.addState('vy');  % velocity vy[m/s]
  ...
  sh.addControl('dFz', 'lb', -1, 'ub', 1);  % Force z[N]
...
%   force_vec_cart=spherical2cartesian([u.dFx;u.dFy;u.dFz],x.x,x.y,x.z);
